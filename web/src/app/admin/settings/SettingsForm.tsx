        ...
        >
          <div className="flex flex-col gap-4">
            ...
            <p>
              ...
              anyone to use AutoLMS without signing in.
            </p>
      ...
      {isEnterpriseEnabled && (
        <>
          ...
          <IntegerInput
            ...
            sublabel="Enter the maximum number of days you would like AutoLMS to retain chat messages. Leaving this field empty will cause AutoLMS to never delete chat messages."
