          ...
          <div className="space-y-6">
            <div>
              ...
              <Input
                ...
                placeholder="Set how AutoLMS should refer to you"
                className="mt-2"
              />
            </div>
            <div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <SubLabel>
                  Allow AutoLMS to reference stored memories in future chats.
                </SubLabel>
              </div>
              <Switch
                ...
                <div className="max-h-64 overflow-y-auto flex flex-col gap-3 pr-1">
                  {personalizationValues.memories.map((memory, index) => (
                    <AutoResizeTextarea
                      key={index}
                      value={memory}
                      placeholder="Write something AutoLMS should remember"
